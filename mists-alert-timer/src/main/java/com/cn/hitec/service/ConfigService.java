...
public class ConfigService {
    ...
    public int initAlertConfigData_distribute() throws Exception{
        ...
        List<String> jsonList = new ArrayList<>();
        /*-----------------分发---------------------------*/
        jsonList.add("{\"DI_name\":\"云图\",\"time_interval\":\"0 0 * * * ? *\",\"should_time\":3600,\"last_time\":4800,\"data_type\":\"气象基本资料\",\"data_source\":\"\",\"contacts\":\"\",\"IP\":\"10.0.74.226\",\"path\":\"/home/datamgr/xts_gwyyj/cloudmap/\",\"file_name\":\"SEVP_NSMC_WXGN_FY2G_E99_ACHN_LNO_P9_*.HDF\",\"transfer_type\":\"ftp推送\"}");
