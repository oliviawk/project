...
function transform_Data(num){
    ...
    //判断是哪类数据
    if (num == "1"){
        data = radar_dataSource.slice(0);
        var newData = [];
        $.ajax({
            type: "GET",
            url: "../js/bigscreenshow/radarResult.json",
            dataType: "json",
            async: false,
            success: function (d) {
                newData = d.RadarBase.ArrivalStations;
            },
            error: function (err) {
                newData = [];
            }
        ...
        data = yubao_dataSource.slice(0);
        var newData = [];
        $.ajax({
            type: "GET",
            url: "../js/bigscreenshow/精细化预报雷达数据.json",
            dataType: "json",
            async: false,
            success: function (d) {
        ...
        $.ajax({
            type: "GET",
            url: "../js/bigscreenshow/常规预报雷达数据.json",
            dataType: "json",
            async: false,
            success: function (d) {
        ...
        data = shikuang_dataSource.slice(0);
        var newData = [];
        $.ajax({
            type: "GET",
            url: "../js/bigscreenshow/实况雷达数据.json",
            dataType: "json",
            async: false,
            success: function (d) {
