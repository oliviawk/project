...
public class DateTool {
     ...
     *
     * @param strDate       日期字符串
     * @param strDateFormat 日期格式，时间类格式：yyyy-MM-dd HH:mm:ss.SSS / yyyyMMdd /yyyyMMdd
     *                      HH:mm:ss
     * @return
     */
     ...
     * 获取月的索引1-12
     *
     * @param obstime：时间字符串 格式yyyy-MM-dd HH:mm:ss
     * @return iMon 1-12
     */
     ...
     *
     * @param iYear：指定年份
     * @param iPen：指定候（1-73） 作者：wufy 时间：2015-07-31 版权：北京华云信息工程有限公司
     */
     ...
     * 获取输入日期加或减去指定时间后的日期
     *
     * @param sourceDate 原始的日期
     * @param minute     加或减的分钟数
     * @return 加减后的日期
     */
    public static Date getDateTimeFromNow(Date sourceDate, int minute) {
