...
public class DataInfo implements Serializable  {
    ...
    public DataInfo(long id, long parent_id, String name, int is_data, int timeout_threshold, String monitor_times, int alert_level, String sub_name, int should_time, String ip, String file_path, String file_size_define, String file_name_define, String module, String service_type, int regular) {
        this.id = id;
